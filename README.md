...
* `<LocalLeader>m`: switch between definition and implementation module
* `:Cloogle search-str`: search for `search-str` on [Cloogle][cloogle]
* `:CloogleWindow`: opens the previous Cloogle search window

...
syn region  cleanRecordDef      start="{"       end="}"   transparent fold containedin=cleanRecordDef
syn match   cleanRecordField    "[{,&|]\@<=\_s*\a[a-zA-Z0-9_`]*\_s*\(::\|[=,}]\)\@=" display contained containedin=cleanRecordDef
